...
<script type="text/javascript">
var myvar = <?php echo json_encode(session('success')); ?>;
if (myvar) {
alert(myvar);	
}
</script>
...
<body>
	...
	<div class="header" id="home1">
		<div class="container">
			<div class="w3l_login">
				<a href="{{ route('login.show') }}"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></a>
				@if(auth()->user())
			...
			<?php $item = Cart::content(); ?>
				<a href="{{ route('cart.view') }}" class="w3view-cart"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i><span class="badge bg-theme">{{ $item->count() }}</span>	</a>
			</div>  
		</div>
	</div>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
								...
								@foreach($all_cat  as $category)
									<div class="col-sm-2">
										<ul class="multi-column-dropdown">
											...
											<li><a href="{{ route('products' , $product->id) }}">{{ $product->title }}</a></li>
											@endif
											@endforeach
										</ul>
									</div>
						...
						@else
						<a href="{{ route('login.show') }}">Login or Signup</a>
						@endif
						</li>
			...
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						...
						<li><a href="{{ route('products',$product->id) }}">Special Products</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Category</h3>
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						...
						<li><a href="{{ route('products',$product->id) }}">Today's Deals</a></li>
					</ul>
					<h4>Follow Us</h4>
